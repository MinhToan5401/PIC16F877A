...
void Step()
{
    ...
    {
        Count1_timer0++;
        if (Count1_timer0 <= Count_TOP1) PORTDbits.RD6 = 1;
    ...
    {
        Count2_timer0++;
        if (Count2_timer0 <= Count_TOP2) PORTDbits.RD7 = 1;
